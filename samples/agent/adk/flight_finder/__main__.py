...
def main(host, port):
  try:
    ...
    ui_agent = FlightAgent(base_url=base_url, use_ui=True)
    text_agent = FlightAgent(base_url=base_url, use_ui=False)

    agent_executor = FlightAgentExecutor(ui_agent, text_agent)
